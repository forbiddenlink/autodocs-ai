  ...
  return (
    ...
    >
      <div className="max-w-2xl w-full text-center">
        {/* Logo/Brand */}
        <div className="mb-8">
          <h1 className="text-6xl font-bold mb-2" style={{ color: '#ffffff' }}>404</h1>
          <div className="text-xl font-semibold mb-4" style={{ color: '#60a5fa' }}>AutoDocs AI</div>
        </div>
        ...
        <div className="pt-8" style={{ borderTop: '1px solid #334155' }}>
          <p className="mb-4 text-sm" style={{ color: '#94a3b8' }}>Or try one of these pages:</p>
