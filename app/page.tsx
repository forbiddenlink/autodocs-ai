...
export default function Home() {
  const structuredData = {
    ...
    operatingSystem: "Web",
    description:
      "AI-powered documentation platform that automatically generates and maintains comprehensive code documentation for your repositories with AI. Connect your GitHub repos and get instant, up-to-date documentation.",
    offers: {
      "@type": "Offer",
      price: "0",
      priceCurrency: "USD",
    ...
    featureList: [
      "AI-Powered Documentation Generation with Claude AI",
      "Auto-Update System with GitHub Webhooks",
      "AI Chat Interface for Code Questions",
      "Code Analysis with Tree-sitter Parser",
      "Beautiful MDX Documentation Rendering",
      "GitHub OAuth Integration",
    ],
    screenshot: `${process.env.NEXT_PUBLIC_BASE_URL || "http://localhost:3000"}/og-image.svg`,
          ...
          <div className="max-w-6xl xl:max-w-7xl mx-auto">
            ...
            >
              ...
              >
                ...
                <p className="text-sm sm:text-base xl:text-lg text-muted-foreground">
                  Tree-sitter parser extracts functions, classes, and relationships to understand
